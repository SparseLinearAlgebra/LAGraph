...
// Grammar: S -> aSb | ab
//
// There are paths from node [1] to node [3] that form the word "ab"
// ([1]-a->[2]-b->[3] and [1]-a->[5]-b->[3]). "ab" word is in language generated by
// our context-free grammar, so pair (1, 3) of nodes will be in result.
//
...
// ([1]-a->[2]-b->[3]-b->[4]). "aab" word is not in language, so pair (1, 4) of nodes
// will not be in result.
//
// With these graph and grammar we get result:
// (0, 4) - because exists path that form word of our language (0-1-2-3-4 or
// 0-1-5-3-4) (1, 3) - because exists path (1-2-3 or 1-5-3)
