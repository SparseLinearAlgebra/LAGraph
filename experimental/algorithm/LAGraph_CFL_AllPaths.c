...
static GrB_Index *merge_all_paths(GrB_Index *n, const void *left, const GrB_Index na,
                                  const void *right, const GrB_Index nb) {
...
void mult_all_paths(AllPathsElem *z, const AllPathsElem *x, GrB_Index ix, GrB_Index jx,
...
void add_get_nvals_all_paths(AllPathsElem *z, const AllPathsElem *x,
...
// Important: Do not free all_paths_ptr_t until all work with the output matrices is
...
GrB_Info LAGraph_CFL_AllPaths(
    ...
    GRB_TRY(GxB_IndexBinaryOp_new(&IAllPaths_mult, (void *)mult_all_paths, AllPaths_type,
                                  AllPaths_type, AllPaths_type, GrB_BOOL,
                                  "mult_all_paths", MULT_PATH_INDEX_DEFN));
