...
#define ADD_INDEX_TO_ERROR_RULE(rule, i)                                                 \
    {                                                                                    \
        rule.len_indexes_str +=                                                          \
            snprintf(rule.indexes_str + rule.len_indexes_str,                            \
...
GrB_Info
LAGraph_CFL_check_grammar_input(int64_t terms_count,    // Number of terminal symbols
...
// LAGraph_CFL_check_base_inputs: Checks the input graph and CFL grammar for algorithms
// working with it Equivalent to calling LAGraph_CFL_check_graph_input +
// LAGraph_CFL_check_grammar_input See LAGraph_CFL_check_graph_input and
// LAGraph_CFL_check_grammar_input for details
GrB_Info LAGraph_CFL_check_base_inputs(
    ...
    LG_TRY(LAGraph_CFL_check_grammar_input(terms_count, nonterms_count, rules_count,
                                           rules, msg));
    return GrB_SUCCESS;
}