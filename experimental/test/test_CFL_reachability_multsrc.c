 ...
 * all vertices selected as sources. Their behaviour should be identical to
 * CFL_reachability.
 */
...
void test_CFL_reachability_allin_1_4(void) {
    ...
    OK(run_algorithm());
    check_result("(1, 0) (1, 1) (1, 2) (1, 3) (1, 4) (1, 5) (4, 0) (4, 1) (4, 2) (4, 3) "
                 "(4, 4) (4, 5)");
...
TEST_LIST = {
    ...
    {"CFL_reachability_labels_more_than_nonterms_allsrc",
     test_CFL_reachability_labels_more_than_nonterms_allsrc},
    {"CFL_reachability_complex_grammar_allsrc",
     test_CFL_reachability_complex_grammar_allsrc},
    ...
    {"CFL_reachability_two_nodes_cycle_allsrc",
     test_CFL_reachability_two_nodes_cycle_allsrc},
