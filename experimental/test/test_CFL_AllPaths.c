...
TEST_LIST = {
             ...
             {"CFL_AllPathsPost_labels_more_than_nonterms", test_CFL_AllPathsPost_labels_more_than_nonterms},
             ...
             {"CFL_AllPathsPost_with_empty_adj_matrix", test_CFL_AllPathsPost_with_empty_adj_matrix},
